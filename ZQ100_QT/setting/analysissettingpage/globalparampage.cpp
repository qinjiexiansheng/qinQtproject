...
void GlobalParamPage::initView()
{
    ...
    m_emissSpinBox->setValue(GlobalParam::getFPGA()->getTempSetup().Emiss);
    ...
    m_distSpinBox->setValue(GlobalParam::getFPGA()->getTempSetup().Emiss);
    ...
    m_ambiTSpinBox->setValue(GlobalParam::getFPGA()->getTempSetup().Tamb);
    ...
    m_reflTSpinBox->setValue(GlobalParam::getFPGA()->getTempSetup().Trefl);
    ...
    m_humiSpinBox->setValue(GlobalParam::getFPGA()->getTempSetup().RelHum);
    ...
    m_offsetSpinBox->setValue(GlobalParam::getFPGA()->getTempSetup().mdf);
...
void GlobalParamPage::applyValue()
{
    //            qWarning("Ok");
    TempSetup setup;
    setup.Emiss = m_emissSpinBox->value();
    setup.Dist = m_distSpinBox->value();
    setup.Tamb = m_ambiTSpinBox->value();
    setup.Trefl = m_reflTSpinBox->value();
    setup.RelHum = m_humiSpinBox->value();
    setup.mdf = m_offsetSpinBox->value();
    GlobalParam::getFPGA()->setTempSetup(setup);
