...
class SpinBox : public QLineEdit
{
    Q_OBJECT
...
public:
    explicit SpinBox(QWidget *parent = 0, GlobalParam::Orientation orientation = GlobalParam::Orientation::HORIZONTAL);
