...
static int makeExifFile ( char *ExifOut, UINT *totalLen ,ExifFileInfo *exifFileInfo)
{
    ...
    tempExif += 4 ;
    santemp= ( unsigned int )(long)( offset );
...
int makeNewSatJpgFromBuf( IN const char *src_file, IN const char *dest_file, IN char *buf, IN int size )
